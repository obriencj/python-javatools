...
OP_bipush = _op('bipush', 0x10, format='>B')

OP_caload = _op('caload', 0x34)
OP_castore = _op('castore', 0x55)
OP_checkcast = _op('checkcast', 0xc0, format='>H', const=True)
...
OP_dload = _op('dload', 0x18, format='>B')
...
OP_dstore = _op('dstore', 0x39, format='>B')
...
OP_fload = _op('fload', 0x17, format='>B')
...
OP_fstore = _op('fstore', 0x38, format='>B')
...
OP_getfield = _op('getfield', 0xb4, format='>H', const=True)
OP_getstatic = _op('getstatic', 0xb2, format='>H', const=True)
OP_goto = _op('goto', 0xa7, format='>h')
OP_goto_w = _op('goto_w', 0xc8, format='>i')
...
OP_if_acmpeq = _op('if_acmpeq', 0xa5, format='>h')
OP_if_acmpne = _op('if_acmpne', 0xa6, format='>h')
OP_if_icmpeq = _op('if_icmpeq', 0x9f, format='>h')
OP_if_icmpne = _op('if_icmpne', 0xa0, format='>h')
OP_if_icmplt = _op('if_icmplt', 0xa1, format='>h')
OP_if_icmpge = _op('if_icmpge', 0xa2, format='>h')
OP_if_icmpgt = _op('if_icmpgt', 0xa3, format='>h')
OP_if_icmple = _op('if_icmple', 0xa4, format='>h')
OP_ifeq = _op('ifeq', 0x99, format='>h')
OP_ifne = _op('ifne', 0x9a, format='>h')
OP_iflt = _op('iflt', 0x9b, format='>h')
OP_ifge = _op('ifge', 0x9c, format='>h')
OP_ifgt = _op('ifgt', 0x9d, format='>h')
OP_ifle = _op('ifle', 0x9e, format='>h')
OP_ifnonnull = _op('ifnonnull', 0xc7, format='>h')
OP_ifnull = _op('ifnull', 0xc6, format='>h')
OP_iinc = _op('iinc', 0x84, format='>Bb')
OP_iload = _op('iload', 0x15, format='>B')
...
OP_instanceof = _op('instanceof', 0xc1, format='>H', const=True)
OP_invokeinterface = _op('invokeinterface', 0xb9, format='>HBB', const=True)
OP_invokespecial = _op('invokespecial', 0xb7, format='>H', const=True)
OP_invokestatic = _op('invokestatic', 0xb8, format='>H', const=True)
OP_invokevirtual = _op('invokevirtual', 0xb6, format='>H', const=True)
OP_ior = _op('ior', 0x80)
OP_irem = _op('irem', 0x70)
OP_ireturn = _op('ireturn', 0xac)
OP_ishl = _op('ishl', 0x78)
OP_ishr = _op('ishr', 0x7a)
OP_istore = _op('istore', 0x36, format='>B')
...
OP_jsr = _op('jsr', 0xa8, format='>h')
OP_jsr_w = _op('jsr_w', 0xc9, format='>i')
...
OP_ldc = _op('ldc', 0x12, format='>B', const=True)
OP_ldc_w = _op('ldc_w', 0x13, format='>H', const=True)
OP_ldc2_w = _op('ldc2_w', 0x14, format='>H', const=True)
OP_ldiv = _op('ldiv', 0x6d)
OP_lload = _op('lload', 0x16, format='>B')
...
OP_lookupswitch = _op('lookupswitch', 0xab, format=_unpack_lookupswitch)
OP_lor = _op('lor', 0x81)
OP_lrem = _op('lrem', 0x71)
OP_lreturn = _op('lreturn', 0xad)
OP_lshl = _op('lshl', 0x79)
OP_lshr = _op('lshr', 0x7b)
OP_lstore = _op('lstore', 0x37, format='>B')
...
OP_new = _op('new', 0xbb, format='>H', const=True)
OP_newarray = _op('newarray', 0xbc, format='>B')
OP_nop = _op('nop', 0x0)

OP_pop = _op('pop', 0x57)
OP_pop2 = _op('pop2', 0x58)
OP_putfield = _op('putfield', 0xb5, format='>H', const=True)
OP_putstatic = _op('putstatic', 0xb3, format='>H', const=True)

OP_ret = _op('ret', 0xa9, format='>B')
OP_return = _op('return', 0xb1)

OP_saload = _op('saload', 0x35)
OP_sastore = _op('sastore', 0x56)
OP_sipush = _op('sipush', 0x11, format='>h')
OP_swap = _op('swap', 0x5f)

OP_tableswitch = _op('tableswitch', 0xaa, format=_unpack_tableswitch)

OP_wide = _op('wide', 0xc4, format=_unpack_wide)
